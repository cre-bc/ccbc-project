...
class ComKokokuMenteForm extends React.Component {
  ...
  handleSubmit = async () => {
    await fetch(restdomain + "/com_kokoku_mente/create", {
      method: "POST",
      mode: "cors",
  ...
  handleSubmitEdit = async () => {
    await fetch(restdomain + "/com_kokoku_mente/edit", {
      method: "POST",
      mode: "cors",
      body: JSON.stringify(this.state),
      headers: new Headers({ "Content-type": "application/json" }),
  ...
  handleSubmitDelete = async () => {
    await fetch(restdomain + "/com_kokoku_mente/delete", {
      method: "POST",
      mode: "cors",
      body: JSON.stringify(this.state),
      headers: new Headers({ "Content-type": "application/json" }),
