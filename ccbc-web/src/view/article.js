        ...
        <div className={classes.appFrame}>
          ...
          <main
            ...
            <div className={classes.categoryTable}>
              <List component="nav" aria-label="mailbox folders">
                {this.state.categoryList.map((item, i) => (
                  <ListItem button divider onClick={this.handleSelectCategory(item)} key={i}>
                        ...
                        <div style={{ float: "right", align: "right" }}>
                          ...
                          <div style={{ float: "left", paddingRight: 10 }}>
                            {(() => {
                              if (item.t_shain_pk == this.state.loginShainPk) {
                                return (
                                  <EditIcon style={{ fontSize: 40, cursor: "pointer" }}
                                    onClick={this.handleOpenEntryEdit.bind(this, i)} />
                                )
                              }
                            })()}
                          </div>
                          ...
                          <div style={{ float: "left", paddingRight: 10 }}>
                            {(() => {
                              ...
                              return (
                                <div>
                                  <img src={goodImageSrc} width="35" height="35" style={{ cursor: "pointer" }}
                          ...
                          <div style={{ float: "left" }}>
                            {(() => {
                              ...
                              return (
                                <Star style={{ fontSize: 40, color: favoriteColor, cursor: "pointer" }}
                  ...
                  <div style={{ width: 350, float: "left", padding: 10 }}>
                    {(this.state.file_path !== "" && !this.state.srcImageUrl) && (
                      <img
                        ...
                        src={restdomain + `/uploads/article/${this.state.file_path}`} />
                    )}
            ...
            <Dialog
              ...
              onClose={() => { this.setState({ alertDialogVisible: false }) }}
            ...
            >
              ...
              <DialogActions>
                <Button
                  onClick={() => { this.setState({ alertDialogVisible: false }) }}
                  color="primary"
                  autoFocus
                >
                  {"OK"}
            ...
            <Dialog
              ...
              onClose={() => { this.setState({ confirmDialogVisible: false }) }}
              aria-labelledby="alert-dialog-title"
              aria-describedby="alert-dialog-description"
            ...
            >
              ...
              <DialogActions>
                ...
                <Button
                  onClick={() => { this.setState({ confirmDialogVisible: false }) }}
                  color="primary"
                >
                  いいえ
                </Button>
